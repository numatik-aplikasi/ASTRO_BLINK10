...
type Kelas = keyof typeof quizGamezData;
...
const QuizGamezPage = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center gradient-space overflow-hidden">
      <Starfield />
      <PageNavigation prevPath="/menu" nextPath="/tugas-mandiri" />
      <div className="relative z-10 max-w-3xl w-full px-4 py-10">
        ...
        <p className="text-white/60 text-sm text-center mb-8 font-body">
          Pilih tingkatan kelas untuk memulai quiz
        </p>

        {!selectedKelas ? (
          <div className="animate-slide-up grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-lg mx-auto">
            {(Object.keys(quizGamezData) as Kelas[]).map((kelas, i) => (
              <button
                key={kelas}
              ...
              >
                ...
                <p className="text-xs text-muted-foreground mt-1 font-body">
                  {quizGamezData[kelas].length} quiz
                </p>
              </button>
            ))}
          </div>
          ...
          <div className="animate-slide-up">
            ...
            <div className="flex flex-col gap-3">
              {quizGamezData[selectedKelas].map((topik, i) => (
                <button
                  key={topik}
                  ...
                  onClick={() => {
                    ...
                    if (topik === "BILANGAN BULAT") {
                      ...
                      navigate("/quiz-gamez/bangun-ruang-sisi-datar");
